...
public class MeasuresMediumTest {
  ...
  public void computeMeasuresOnTempProject() throws IOException {
    ...
    assertThat(allMeasures.get("com.foo.project")).extracting("metricKey", "intValue", "doubleValue", "stringValue").containsOnly(
      Tuple.tuple(CoreMetrics.DIRECTORIES_KEY, 1, 0.0, ""),
      Tuple.tuple(CoreMetrics.DUPLICATED_BLOCKS_KEY, 0, 0.0, ""),
      Tuple.tuple(CoreMetrics.DUPLICATED_FILES_KEY, 0, 0.0, ""),
      Tuple.tuple(CoreMetrics.DUPLICATED_LINES_KEY, 0, 0.0, ""),
      Tuple.tuple(CoreMetrics.DUPLICATED_LINES_DENSITY_KEY, 0, 0.0, ""),
      Tuple.tuple(CoreMetrics.FILES_KEY, 1, 0.0, ""),
    ...
    assertThat(allMeasures.get("com.foo.project:src/sample.xoo")).extracting("metricKey", "intValue").containsOnly(
      Tuple.tuple(CoreMetrics.FILES_KEY, 1),
