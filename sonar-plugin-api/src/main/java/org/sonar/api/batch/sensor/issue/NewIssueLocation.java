...
public interface NewIssueLocation {
  ...
  /**
   * Position in the file. Only valid when {@link #onFile(InputFile)} has been called. See {@link InputFile#newRange(org.sonar.api.batch.fs.TextPointer, org.sonar.api.batch.fs.TextPointer)}
   */
