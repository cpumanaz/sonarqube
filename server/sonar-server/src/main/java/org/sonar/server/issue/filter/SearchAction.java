...
public class SearchAction implements RequestHandler {
  ...
  public SearchAction(IssueFilterService service, IssueFilterWriter issueFilterWriter, UserSession userSession) {
  ...
  public void handle(Request request, Response response) throws Exception {
    ...
    if (userSession.isLoggedIn()) {
      ...
      for (IssueFilterDto favorite : favorites) {
        json.beginObject();
        issueFilterWriter.writeUnwrapped(userSession, favorite, json);
        json.endObject();
      }
      json.endArray();
    }
